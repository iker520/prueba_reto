...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initActividades() {
        ...
        a1.setPrecio(new BigDecimal("45.00"));
        ...
        a2.setPrecio(new BigDecimal("320.00"));
        a2.setTipo("CURSO");
        ...
        a3.setPrecio(new BigDecimal("280.00"));
        a3.setTipo("CURSO");
        ...
        a4.setPrecio(new BigDecimal("55.00"));
        ...
        a6.setPrecio(new BigDecimal("350.00"));
        a6.setTipo("OFERTA");
